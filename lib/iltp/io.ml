...
let parserfun_problem =
    MenhirLib.Convert.Simplified.traditional2revised P.xproblem
...
let parse_problem (reader : reader) =
  parserfun_problem (fun () -> lexer (lexbuf reader))
